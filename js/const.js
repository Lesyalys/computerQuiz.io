export const backgroundImages = [
    'url("/computerQuiz.io/imgLight/modalBack.png")',
    'url("/computerQuiz.io/imgLight/modalBack2.png")',
    'url("/computerQuiz.io/imgLight/modalBack3.png")',
];
export const backgroundImages2 = [
    'url("/computerQuiz.io/imgDark/modalBack.png")',
    'url("/computerQuiz.io/imgDark/modalBack2.png")',
    'url("/computerQuiz.io/imgDark/modalBack3.png")',
];
...
export const questionsData = [
    {
        ...
        questions: [
            ...
            { text: "К какому типу периферийных устройств относится клавиатура?", img:'click.png', answer: "Устройство ввода", points: 20 },
            { text: "Как называется устройство для ввода рукописного текста и рисунков в компьютер? ", img:null, answer: "Графический планшет", points: 30 },
            { text: "Какой тип принтера использует порошковый краситель для печати?", img:null, answer: "Лазерный принтер", points: 40 },
            { text: "Как называется данный разьем?", img:'rca.jpg', answer: "SPDIF 'тюльпан'", points: 50 },
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "Как называется микросхема или набор микросхем, который управляет работой материнской платы и взаимодействием её компонентов?  ", img:null, answer: "Чипсет", points: 90 },
            { text: "Как называется кэш центрального процессора,используемый для ускорения трансляции адреса виртуальной памяти в адрес физической памяти", img:null, answer: "Буфер ассоциативной трансляции (Translation lookaside buffer)", points: 100 }
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "Как звали женщину, считающуюся первым программистом, которая писала алгоритмы для аналитической машины?", img: null, answer: "Ада Лавлейс", points: 40 },
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "Как называется файловая система в microsoft windows?",img:null,  answer: "NTFS", points: 70 },
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "Как называется способ сортировки списка путем сравнения соседних элементов и обмена местами, если следующий элемент меньше предыдущего? ", img:'buble.jpg', answer: "Сортировка пузырьком", points: 40 },
            { text: "Как называется алгоритм обхода дерева, который посещает узлы в порядке 'левый потомок --> родитель --> правый потомок'?",img:null,  answer: "Центрированный обход (In-order traversal) / ЛКП", points: 50 },
            { text: "Какой алгоритм используется для нахождения кратчайшего пути в графе?", img:null, answer: "Алгоритм Дейкстры", points: 60 },
            { text: "Назовите основную цель алгоритма Евклида",img:'evclid.jpg',  answer: "Поиск наибольшего общего делителя (НОД)", points: 70 },
            ...
            { text: "Как называется алгоритм для нахождения минимального остовного дерева в связном взвешенном графе?", img:'three.png', answer: "Алгоритм Краскала (или Алгоритм Прима)", points: 90 },
